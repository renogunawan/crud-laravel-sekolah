...
<h1 style="color: white"><center> SISWA</center></h1> 

&nbsp;&nbsp;<a href="http://127.0.0.1:8000/siswa/create" class="btn btn-primary"><i class="fa fa-user-plus"></i> Add Data</a>
                ...
                <td>
                    <center>
                        <form id="delete-form-{{ $siswa->id }}" action="{{ route('siswa.destroy', $siswa->id) }}" method="POST">
                            ...
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" onclick="showAlert(event, {{ $siswa->id }})">Delete</button>
                        </form>
                    </center>
